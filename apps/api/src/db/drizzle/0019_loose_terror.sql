...
ALTER TABLE "group" RENAME COLUMN "location" TO "location_id";--> statement-breakpoint
ALTER TABLE "tournament" RENAME COLUMN "location" TO "location_id";--> statement-breakpoint
