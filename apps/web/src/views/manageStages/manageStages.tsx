...
export default function ManageStages(tournament?: ITournamentResponse) {
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <h3 className={globals[`${theme}Color`]}>manage your group stages</h3>
      </div>
              ...
              >
                {page.results.map((stage) => (
                  ...
                  >
                    ...
                    <p className={globals.label}>
                      status <b className={styles.info}> {stage.stageStatus}</b>
                    </p>
                    {stage?.location?.name && (
                      <p className={globals.label}>
                        location{" "}
                        <b className={styles.info}> {stage?.location?.name}</b>
                      </p>
                    )}
                    <p className={globals.label}>
                      stage type{" "}
